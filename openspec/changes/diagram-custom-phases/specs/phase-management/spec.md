...
**Reason**: This requirement belongs to the `diagram-types` spec; it is listed here only to confirm it is NOT being changed by this feature.
**Migration**: No action needed — diagram type immutability is unchanged.
